...
from observer_hooks.ObserverHooks import  BoundEvent, EventDescriptor, EventHandler, FunctionStub
...
def notify(event_name: str = None, no_origin=False, is_method=None, auto_fire=True, handler_t=EventHandler, pass_ref=False) -> Callable[
